...
FOUND_JAVA_HOME=`"$APP_HOME/gradle/find-gradle-java.sh"` || die "Unable to locate a Gradle-compatible JDK."
JAVA_HOME="$FOUND_JAVA_HOME"
export JAVA_HOME
JAVACMD="$JAVA_HOME/bin/java"
[ -x "$JAVACMD" ] || die "ERROR: selected JAVA_HOME is invalid: $JAVA_HOME"
