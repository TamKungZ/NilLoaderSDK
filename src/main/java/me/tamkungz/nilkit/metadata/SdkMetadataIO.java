...
public final class SdkMetadataIO {
    ...
    public static final String DEFAULT_METADATA_FILE = "nilkit.nilsdkmod.kdl";
    public static final String LEGACY_METADATA_FILE = "nilkit.metadata.kdl";
    public static final String LEGACY_METADATA_FILE_2 = "nilkit.kdl";
