package me.tamkungz.nilkit.metadata;

import me.tamkungz.nilkit.util.kdl.KdlDocument;
import me.tamkungz.nilkit.util.kdl.KdlNode;
import me.tamkungz.nilkit.util.kdl.KdlParser;
import me.tamkungz.nilkit.util.kdl.KdlValue;
import me.tamkungz.nilkit.util.kdl.KdlWriter;
...
public final class SdkMetadataKdl {
    ...
    public static String write(SdkModMetadata metadata) {
        ...
        KdlNode root = new KdlNode("nilkit");
    ...
    private static List<KdlNode> selectMetadataNodes(KdlDocument document) {
        ...
        for (KdlNode node : document.getNodes()) {
            if ("nilkit".equalsIgnoreCase(node.getName())) {
